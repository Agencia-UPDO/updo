...
export default function CaseEducacao() {
  return (
    <main className="flex flex-col">
      ...
      <section className="relative overflow-hidden pt-28 pb-24 lg:pt-40 lg:pb-32">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <span className="inline-flex items-center rounded-full border border-[#3B82F6]/25 bg-[#3B82F6]/10 px-3 py-1 text-[10px] font-black uppercase tracking-[0.25em] text-[#3B82F6]/80 mb-8">
              Case · Instituição de Ensino Superior
            </span>

            <h1 className="font-heading font-black text-white tracking-tight leading-none">
              <span className="block text-7xl md:text-9xl bg-[linear-gradient(135deg,#3B82F6_20%,#60A5FA_80%)] bg-clip-text text-transparent">
                ROAS 20x
              </span>
              <span className="block mt-3 text-2xl md:text-3xl text-white/30 font-black">
                e +211% de leads gerados
              </span>
            </h1>
          ...
          >
            {keyMetrics.map((m) => (
              ...
              >
                <m.icon
                  className={`h-3.5 w-3.5 ${m.highlight ? "text-[#3B82F6]/60" : "text-white/20"}`}
                />
                <span
                  className={`text-2xl lg:text-3xl font-black tracking-tight leading-none ${
                    m.highlight ? "text-[#3B82F6]" : "text-white"
                  }`}
                >
                  {m.value}
                </span>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              {solution.map((s, i) => (
                ...
                >
                  <span className="flex h-8 w-8 items-center justify-center rounded-full bg-[#3B82F6]/10 text-xs font-black text-[#3B82F6]">
                    {s.step}
                  </span>
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <div className="mt-5 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3 rounded-2xl border border-[#3B82F6]/20 bg-[#3B82F6]/[0.04] p-6">
                <CheckCircle2 className="h-4 w-4 text-[#3B82F6] mt-0.5 shrink-0" />
      ...
      <section className="py-24 lg:py-32 bg-[#F7F9FF]">
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-100 mb-8">
              <Trophy className="h-8 w-8 text-amber-500" />
            </div>
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground/40 block mb-3">
              Reconhecimento
            </span>
            ...
            <p className="mt-5 text-foreground/60 leading-relaxed text-[15px] max-w-xl mx-auto">
            ...
            <div className="mt-8 inline-flex items-center gap-3 rounded-full border border-amber-200 bg-amber-50 px-6 py-3">
          ...
          >
            ...
            <div className="flex flex-col gap-3">
              {learnings.map((l, i) => (
                ...
                >
                  <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#3B82F6]/[0.07] text-[10px] font-black text-[#3B82F6]/60">
                    0{i + 1}
                  </span>
                  <div className="pt-1">
                    <l.icon className="h-3.5 w-3.5 text-[#3B82F6]/25 mb-2" />
      ...
      <section className="py-24 lg:py-32 bg-[#0A1529] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#3B82F6]/[0.06] rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/#contato"
                className="inline-flex items-center gap-2.5 rounded-full bg-[#3B82F6] px-8 py-4 text-sm font-bold text-white shadow-[0_0_20px_rgba(59,130,246,0.30)] hover:shadow-[0_0_30px_rgba(59,130,246,0.50)] hover:bg-[#2563eb] transition-all duration-200"
              >
